...
This module adds the partner code program territory in sale orders and sale reports
...
#. Create a sales order with that partner. Now you can filter and group by code program territory
